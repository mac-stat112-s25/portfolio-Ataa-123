...
courses |>
  ...
  summarize(n()) |>
  arrange(n()) |>
  head() # Change this to do it correctly
...
courses_clean <- courses |>
  ...
  mutate(enroll = as.numeric(avail, max)) |> #What am I supposed to do with this. Don't know what enroll is supposed to be 
...
courses_clean |>
  group_by(dept) |>
  summarize(name = mean(str_length(name))) |>
  arrange(desc(name)) |>
  head()
```

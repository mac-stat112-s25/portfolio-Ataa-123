...
ggplot(hikes, aes(x = rating)) +
  ...
  labs(x = "Rating", y = "Number of hikes")
# Now the outline of the bars is orange due to geom_bar(color = "orange", fille = "blue")
```
...
When you want to do something different with the plot/make a change in a thing that hasn't been changed yet such as background or bars then the + adds that and you can change it

-   We added the bars using `geom_bar()`? Why "geom"?
"geom" might stand for geometric, for square bars maybe

-   What does `labs()` stand for?
'labs()' allows you to label the x and y axis and likely stands for label

-   What's the difference between `color` and `fill`?
color is the outline of the bar and fill is the inside of the bar
...
moderate was much more common than the other types

We must then *translate* this information into the *context* of our analysis, here hikes in the Adirondacks. Summarize below what you learned from the bar chart, in context.
We saw that of the hikes in the data set most of them are of moderate difficulty and a few are easy and even less are difficult

#### Part c {.unnumbered}

Is there anything you don't like about this barplot? For example: check out the x-axis again.
It would make more sense to order it easy, moderate, difficult rather than difficult, easy, moderate
...
The range is 1524 and distribution might be normal
2. What's a *typical* elevation?
The median elevation is about 4400 feet
...
It's not very clear and the count is not what we would want in this data set
...
-   INTUITION CHECK: Before tweaking the code and thinking back to `geom_bar()` and `geom_histogram()`, how do you *anticipate* the following code will change the plot?
    ...
    will change the color of the outline that we see
    -   `geom_density(fill = "orange")`
    will change color of the area under the line
...
Makes it clear that these lines are apart of the ggplot
```{r eval = FALSE}
# YUCK
ggplot(hikes, aes(x = elevation)) +
geom_histogram(color = "white", binwidth = 200) +
